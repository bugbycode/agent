...
echo "spring.oauth.oauthUri=https://${baseHost}/agent-oauth2/oauth/token" >> agent/config/application.properties
echo "console.uri=https://${baseHost}/proxy-console/api/getConnHost" >> agent/config/application.properties
